# -*- coding: utf-8 -*-
"""
Created on Mon Jan  8 22:39:35 2018
...
model = Sequential()
#model.add(LSTM(batch, input_shape=(1, look_back),return_sequences=True))
model.add(Dense(1,input_shape=(1, look_back)))
model.add(Activation('sigmoid'))
model.add(LSTM(batch))
model.add(Dense(1))
...
plt.savefig('truerate_for_day_atension')
plt.show()
...
plt.legend()
plt.title('long term predict')
plt.savefig("{}_longafter_attension.png".format(daylong))
plt.show()
